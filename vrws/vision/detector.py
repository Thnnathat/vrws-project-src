...
from pyzed.sl import Mat 
from threading import Lock, Event
class Detector:
    def __init__(self, event: Event, model: str, img_size: int = 640, conf_thres: float = 0.8, iou_thres: float = 0.45) -> None:
        ...
        print("Class name:", self.model.names)
    ...
    def detections_to_custom_box(self, detections: Boxes, im0: Mat):
        output = []
    ...
    def xywh2abcd(self, xywh, imshape):
        output = np.zeros((4, 2))
